        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <div class="menu-item">
                        <a class="menu-link" href="{{ route('about.edit', ['id' => 1]) }}" title="Main Page - Products" data-bs-toggle="tooltip"
                           data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                            <i class="fa-brands fa-product-hunt fs-2"></i>
                    ...
                    <div class="menu-item">
                        <a class="menu-link" href="{{ route('faqs.index') }}" title="Main Page - Products" data-bs-toggle="tooltip"
                           data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                            <i class="fa-brands fa-product-hunt fs-2"></i>
